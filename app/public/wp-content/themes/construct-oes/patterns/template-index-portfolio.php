 ...
 * Slug: construct-oes/template-index-portfolio
...
<main class="wp-block-group alignfull">
	...
	<h1 class="wp-block-heading alignwide" style="padding-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'Posts', 'construct-oes' ); ?></h1>
	<!-- /wp:heading -->
