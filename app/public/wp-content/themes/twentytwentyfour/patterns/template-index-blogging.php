 ...
 * Slug: construct-oes/template-index-blogging
...
<main class="wp-block-group" style="margin-top:0">
	...
	<h1 class="wp-block-heading" style="padding-top:var(--wp--preset--spacing--50);line-height:1"><?php esc_html_e( 'Watch, Read, Listen', 'construct-oes' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:pattern {"slug":"construct-oes/posts-1-col"} /-->
</main>
<!-- /wp:group -->
