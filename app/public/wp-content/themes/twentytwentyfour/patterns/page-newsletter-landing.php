 ...
 * Slug: construct-oes/page-newsletter-landing
 * Categories: call-to-action, construct-oes_page, featured
 * Keywords: starter
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button">
				<a class="wp-block-button__link wp-element-button"><?php echo esc_html_x( 'Sign up', 'Sample content for newsletter subscribe button', 'construct-oes' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
