 ...
 * Slug: construct-oes/banner-project-description
...
<div class="wp-block-group alignfull has-accent-2-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<p><?php echo esc_html_x( 'Art Gallery — Overview', 'Sample title for a project or post', 'construct-oes' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	...
	<figure class="wp-block-image alignwide size-large is-style-rounded">
		<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/hotel-facade.webp" alt="<?php esc_attr_e( 'Hyatt Regency San Francisco, San Francisco, United States', 'construct-oes' ); ?>" />
	</figure>
	<!-- /wp:image -->
</div>
<!-- /wp:group -->
